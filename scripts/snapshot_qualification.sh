...
printf '%s\n' 'Snapshot qualification passed: deterministic 512-file indexing, serialized metadata bounds, subtree reuse, sparse journal persistence, and metadata-page exchange validation passed in default and swarm-v2 builds.'
